...
const RICH_TASKS = {
  ...
  Emotiecoaching: [
    ...
    },
    {
      ...
      desc: "Bij verdriet: zit erbij in stilte. Zeg 1x: 'Ik ben hier.'",
  ...
  Zelfregulatie: [
    {
      ...
      desc: "Check {count}x vandaag: hoe boos ben ik op schaal 1-10?",
      waarom: "Bewustzijn is de eerste stap - je kunt pas reguleren wat je ziet.",
      tip: "Bij 7+: neem een pauze voor je reageert.",
  ...
  Grenzen: [
    ...
    },
    {
      ...
      waarom: "Consistentie leert: deze grens is echt. Varieren = onderhandelen.",
      tip: "Plaat met een deuk: letterlijk dezelfde woorden, 3x if needed.",
      vermijd: "Harder praten of uitleggen blijven - dat is escalatie.",
      dur: 2
    },
    {
      title: "Eerst-dan",
      desc: "Gebruik vandaag {count}x de 'eerst-dan' formule.",
  ...
  Autonomie: [
    ...
    },
    {
      ...
      tip: "Jas vergeten? Laat het gebeuren. Een dag kou leert meer dan 100x zeggen.",
  ...
  Reflectie: [
    {
      ...
      desc: "Noteer: wanneer werd ik geirriteerd? Wat was de trigger?",
