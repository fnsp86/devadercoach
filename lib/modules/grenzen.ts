...
export const GRENZEN_MODULES: LearningModule[] = [
{
  ...
  content: [
    ...
    {
      type: "example" as const,
      situation: "Thijs (6) wil na school altijd nog een uur op de iPad. Als papa zegt dat het tijd is om te stoppen, begint Thijs te schreeuwen en te onderhandelen: 'Nog vijf minuutjes! Nog één spelletje!'",
      wrongApproach: "❌ GRENS VERSCHUIVEN:\n\nPapa: 'Oké, nog vijf minuten dan.' Na vijf minuten: Thijs gilt weer. Papa: 'Echt de laatste vijf minuten!' Thijs leert: gillen werkt. De grens schuift steeds op. Hij voelt niet waar de rand is en wordt steeds onrustiger.",
      rightApproach: "✅ VOORSPELBARE GRENS:\n\nPapa zet vooraf een timer: 'Thijs, als de timer gaat, is het klaar. Dan gaan we buiten spelen.' Timer gaat. Thijs protesteert. Papa: 'De timer zegt dat het klaar is. Kom, we gaan naar buiten.' Pakt rustig de iPad. Geen discussie.\n\nThijs moppert. Maar na een week weet hij: de timer is de timer. Hij stopt met onderhandelen.",
      explanation: "De timer maakt de grens onpersoonlijk. Thijs vecht niet tegen papa maar tegen de afspraak. Dat maakt het makkelijker om te accepteren. En papa hoeft niet de 'slechterik' te zijn. De voorspelbaarheid geeft Thijs het hekje waar hij op kan vertrouwen.",
    },
    {
      type: "text" as const,
      heading: "Je toolkit",
...
},
{
  ...
  content: [
    ...
    {
      type: "example" as const,
      situation: "Noor (8) wil op een doordeweekse avond naar een vriendinnetje. Het is al 18:00 en morgen is er school. Papa zegt nee. Noor: 'Alle andere vaders vinden het wél goed!'",
      wrongApproach: "❌ BOOS WORDEN:\n\nPapa: 'Hou op met dat gezeur! Het is nee en daarmee uit! Naar je kamer als je zo doorgaat!'\nNoor rent huilend weg. Slaat haar deur dicht.\n\nDe grens stond. Maar Noor voelt zich afgewezen. Ze leert: mijn wensen zijn lastig. En papa wordt boos als ik iets vraag.",
      rightApproach: "✅ VALIDEREN EN VASTHOUDEN:\n\nPapa: 'Je wilt graag naar Lisa. Logisch, jullie hebben altijd lol samen.'\nNoor: 'Dus ik mag?'\nPapa: 'Niet vanavond. Het is al laat en morgen heb je school. Zullen we samen kijken wanneer het wel kan?'\nNoor zucht diep. Papa: 'Ik snap dat het baal is.'\n\nDe grens stond. En Noor voelde: papa snapt me, ook als het nee is.",
      explanation: "Papa erkende Noors wens zonder toe te geven. Door een alternatief moment aan te bieden ('wanneer wel?') voelt het nee minder definitief. Noor leert: papa luistert, maar de grens blijft. Dat is verbinding én structuur.",
    },
    {
      type: "text" as const,
      heading: "Je toolkit",
...
},
{
  ...
  content: [
    ...
    {
      type: "example" as const,
      situation: "Sophie (8) gooit uit frustratie haar bord spaghetti op de grond omdat ze geen toetje krijgt voordat ze haar eten op heeft.",
      wrongApproach: "❌ WILLEKEURIGE STRAF:\n\nPapa: 'Dat doe je niet! Dit weekend geen zwemles en je mag niet naar het feestje van Emma!'\nSophie huilt. Is boos. Snapt niet wat zwemles met spaghetti te maken heeft.\n\nWat leerde Sophie? Papa pakt dingen af als hij boos is. Geen link tussen haar actie en het gevolg. Alleen angst.",
      rightApproach: "✅ LOGISCHE CONSEQUENTIE + HERSTEL:\n\nPapa haalt adem. 'Je bent boos over het toetje. Dat mag. Maar het eten op de grond gooien mag niet.'\nPapa pakt een doekje en geeft het aan Sophie. 'Jij hebt het gegooid, jij ruimt het op.'\nSophie ruimt mopperend op.\nPapa: 'Wil je nog een boterham? Dan kun je toch nog iets eten.'",
      explanation: "Sophie ervaart het logische gevolg: gooien betekent opruimen. Geen willekeurige straf maar een directe link. Ze leert verantwoordelijkheid nemen voor haar actie. En papa biedt daarna een nieuwe kans, zonder wrok.",
    },
    {
      type: "text" as const,
      heading: "Je toolkit",
...
},
{
  ...
  content: [
    ...
    {
      type: "example" as const,
      situation: "Luna (10) wil haar kamer niet opruimen. Ze heeft ook haar huiswerk nog niet gemaakt. En ze weigert haar jas op te hangen. Papa voelt drie gevechten tegelijk aankomen.",
      wrongApproach: "❌ ALLES TEGELIJK:\n\nPapa: 'Luna! Kamer opruimen! Huiswerk maken! En hang je jas op! Nu!'\nLuna: 'Doe ik straks!' Papa: 'Nee, NU!' Discussie over alle drie tegelijk. Luna sluit zich af. Niks gebeurt.\n\nResultaat: drie gevechten, nul gewonnen. Papa is gefrustreerd. Luna is boos. Alles is stil blijven liggen.",
      rightApproach: "✅ ÉÉN GEVECHT KIEZEN:\n\nPapa denkt: wat is nu het belangrijkst? Huiswerk, want dat moet morgen af. De jas? Groen. De kamer? Kan morgen.\n\nPapa: 'Luna, het huiswerk moet vanavond af. Zal ik een thee voor je maken terwijl jij begint?'\nLuna zucht maar pakt haar boeken.\n\nDe jas hangt papa zelf op. De kamer doet hij morgen rustig.",
      explanation: "Papa koos het gevecht dat ertoe deed: huiswerk met een deadline. De jas en de kamer liet hij bewust gaan. Door één ding te vragen in plaats van drie, kreeg Luna geen overload en deed ze het wél. Slim kiezen levert meer op dan alles eisen.",
    },
    {
      type: "text" as const,
      heading: "Je toolkit",
...
},
{
  ...
  content: [
    ...
    {
      type: "example" as const,
      situation: "Daan (9) wil elke avond langer opblijven om te gamen. Soms zegt papa om 20:00 dat het klaar is, soms vergeet hij het en is het ineens 21:30. Daan weet nooit waar hij aan toe is.",
      wrongApproach: "❌ WISSELEND ZONDER SYSTEEM:\n\nMaandag: 'Om acht uur uit, Daan.' Dinsdag: papa is moe, zegt niks, Daan gamet tot half tien. Woensdag: 'Het is veel te laat! Waarom zit je nog achter dat scherm?!'\nDaan: 'Gisteren mocht het ook!'\n\nDaan leert: er is geen echte regel. Het hangt af van of papa oplette. Dus gewoon doorgaan tot hij iets zegt.",
      rightApproach: "✅ SYSTEEM MET AUTOMATISCHE GRENS:\n\nPapa stelt samen met Daan een schermtijdregel op: 'Doordeweeks tot 20:00. Weekend tot 21:00.' De router schakelt het wifi automatisch uit op die tijden.\n\nDaan: 'Papa, het internet doet het niet!'\nPapa: 'Klopt. Het is acht uur. Dat is de afspraak. Wil je nog een boek lezen voor het slapen?'\n\nPapa hoefde niet op te letten, te herinneren of te schreeuwen. Het systeem deed het.",
      explanation: "Door de grens te automatiseren hoeft papa niet elke avond opnieuw de confrontatie aan te gaan. Het systeem is de grens, niet papa's energieniveau. Daan weet precies waar hij aan toe is. Geen verrassingen, geen gevechten.",
    },
    {
      type: "text" as const,
      heading: "Je toolkit",
