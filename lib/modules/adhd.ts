...
export const ADHD_MODULES: LearningModule[] = [
  {
    ...
    content: [
      ...
      {
        type: "text" as const,
        heading: "Je gereedschapskist: vijf strategieen die werken bij ADHD",
