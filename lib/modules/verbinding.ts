...
export const VERBINDING_MODULES: LearningModule[] = [
{
  ...
  content: [
    ...
    {
      type: "example" as const,
      situation: "Noor (4) is net wakker uit haar middagdutje en wil op papa's schoot zitten. Papa is druk bezig met een deadline voor werk en zit achter zijn laptop aan de keukentafel.",
      wrongApproach: "❌ AFSCHUIVEN EN DOORWERKEN:\n\nNoor komt de keuken in, wrijft in haar ogen. 'Papa, optillen.'\nPapa: 'Niet nu schat, papa moet werken.'\nNoor: 'Maar ik wil bij jou zitten...'\nPapa: 'Ga maar even tv kijken. Ik kom zo.'\nNoor sjokt naar de bank. Papa komt niet 'zo.'\n\nDrie opnames in dertig seconden. Afwijzing, doorverwijzing, gebroken belofte.",
      rightApproach: "✅ TWEE MINUTEN TANKEN:\n\nNoor komt de keuken in. 'Papa, optillen.'\nPapa klapt laptop dicht. Tilt haar op, zet haar op schoot.\n'Hé slaapkop. Lekker geslapen?'\nNoor knikt, leunt tegen hem aan. Twee minuten stilte.\nPapa: 'Zal ik je even een beker melk pakken? Dan ga ik nog even werken.'\nNoor knikt, glijdt van zijn schoot. Tevreden.\n\nTwee minuten investering. Tank vol. Noor speelt daarna een uur alleen.",
      explanation: "Een kind dat net wakker is, zoekt geen uur aandacht. Ze zoekt bevestiging: ben je er? Twee minuten op schoot is genoeg om het saldo aan te vullen. De laptop kost twee minuten vertraging. De afwijzing kost een uur onrust.",
    },
    {
      type: "text" as const,
      heading: "Je toolkit",
...
},
{
  ...
  content: [
    ...
    {
      type: "example" as const,
      situation: "Finn (11) wordt elke ochtend bij school afgezet. Hij stapt uit de auto, zegt 'doei' en loopt weg. Papa wil meer, maar Finn is op een leeftijd dat een knuffel bij het hek 'gênant' is.",
      wrongApproach: "❌ DE KNUFFEL FORCEREN:\n\nPapa: 'Geen knuffel meer tegenwoordig?'\nFinn rolt met zijn ogen. 'Papa, doe normaal.'\nPapa: 'Vroeger rende je altijd naar me toe.'\nFinn: 'Ik ben geen kleuter meer.' Loopt weg.\n\nPapa wilde verbinding. Maar hij deed het via schuldgevoel. Finn voelt zich bekritiseerd in plaats van geliefd.",
      rightApproach: "✅ HET GEHEIME SIGNAAL:\n\nPapa bedenkt iets. 'Finn, wij hebben iets nodig. Een geheim teken. Alleen wij weten wat het betekent.'\nFinn, nieuwsgierig: 'Zoals wat?'\nPapa tikt twee keer op het dashboard. Finn grijnst. Tikt twee keer terug.\nElke ochtend bij het uitstappen: twee tikken op het dashboard. Niemand ziet het.\nWeek drie: Finn vergeet zijn broodtrommel, rent terug. Tikt twee keer op het raam en lacht.\n\nGeen knuffel nodig. De geheime taal past bij wie hij nu is.",
      explanation: "Finn is niet minder gehecht. Hij is elf. Zichtbare affectie bij het schoolhek past niet meer bij zijn wereld. Het geheime signaal geeft hem verbinding zonder zichtbaarheid. Het is exclusief, het is van hen, en het respecteert zijn groeiende behoefte aan autonomie. De taal groeit mee met het kind.",
    },
    {
      type: "text" as const,
      heading: "Je toolkit",
...
},
{
  ...
  content: [
    ...
    {
      type: "example" as const,
      situation: "Sophie (10) weigert om haar kamer op te ruimen. Papa heeft het al drie keer gevraagd. Hij voelt de irritatie stijgen.",
      wrongApproach: "❌ DE ESCALATIE:\n\nPapa, vanuit de gang: 'Sophie! Die kamer! Nu!'\nSophie: 'Straks!'\nPapa loopt naar haar kamer. 'Je hebt straks niet. Ik tel tot drie.'\nSophie: 'Waarom moet het altijd meteen?!'\nPapa: 'Omdat ik het zeg. Eén... twee...'\nSophie gooit een knuffel op de grond. 'Hier! Opgeruimd!'\n\nDe kamer is 'opgeruimd.' De sfeer is kapot. Sophie heeft geleerd: machtsvertoon wint. Volgende keer wordt ze stiller, niet opgeruimder.",
      rightApproach: "✅ HET EERLIJKE OVERLEG:\n\nPapa gaat op de rand van haar bed zitten. 'Soph, ik merk dat ik gefrustreerd word. En ik wil niet gaan schreeuwen. Help me even.'\nSophie kijkt op. 'Ik haat opruimen.'\nPapa: 'Snap ik. Ik ook eerlijk gezegd. Wat als we een deal maken? Jij kiest wanneer het vandaag gebeurt. Maar voor het slapengaan is de vloer vrij.'\nSophie: 'Na het eten?'\nPapa: 'Deal. Wil je dat ik help met de eerste vijf minuten?'\nSophie knikt.\n\nGeen strijd. Wel een grens. En Sophie mocht meedenken.",
      explanation: "Papa liet zijn frustratie zien zonder die als wapen te gebruiken. Door eerlijk te zijn ('ik wil niet gaan schreeuwen') gaf hij Sophie een repair attempt. Door haar te laten kiezen wanneer gaf hij autonomie binnen de grens. Het resultaat: de kamer wordt opgeruimd en de relatie is sterker in plaats van beschadigd.",
    },
    {
      type: "text" as const,
      heading: "Je toolkit",
...
},
{
  ...
  content: [
    ...
    {
      type: "example" as const,
      situation: "Sem (6) bouwt een blokkentoren in de woonkamer. Papa komt erbij zitten en wil helpen.",
      wrongApproach: "❌ PAPA NEEMT OVER:\n\nSem stapelt blokken scheef op elkaar. Papa pakt een blok.\n'Wacht, als je hem zo neerzet valt hij om. Kijk, zo moet het.'\nSem: 'Maar ik wil het zo!'\nPapa: 'Maar dan valt je toren.' Bouwt de onderkant opnieuw.\nSem kijkt toe. Staat op. Loopt weg.\n\nPapa bouwde de mooiste toren. Alleen. Sem leerde: mijn manier is niet goed genoeg.",
      rightApproach: "✅ PAPA VOLGT:\n\nSem stapelt blokken scheef op elkaar. Papa gaat naast hem zitten.\n'Wauw. Hoe hoog gaat deze worden?'\nSem: 'Tot het plafond!'\n'Wat moet ik doen?'\nSem: 'Jij geeft de rode blokken aan.'\nPapa geeft rode blokken. De toren valt om. Sem lacht.\n'Opnieuw! Nog hoger!'\n\nPapa deed niks bijzonders. Hij volgde. En Sem voelde: mijn idee is goed genoeg om papa te laten meedoen.",
      explanation: "Het verschil zit in wie er leidt. In het eerste scenario corrigeert papa en neemt hij het spel over. Sem verliest eigenaarschap en loopt weg. In het tweede stelt papa vragen en volgt hij Sems plan. Zelfs als de toren omvalt, is dat niet erg. Het was Sems toren, Sems plan, Sems spelregels. Dat is waar eigenwaarde groeit.",
    },
    {
      type: "text" as const,
      heading: "Je toolkit",
...
},
{
  ...
  content: [
    ...
    {
      type: "example" as const,
      situation: "Roos (6) moet elke ochtend naar school gebracht worden. Papa fietst met haar achterop. Het is een rit van tien minuten. Meestal in stilte.",
      wrongApproach: "❌ HET EFFICIËNTE RITJE:\n\nPapa fietst. Roos zit achterop.\nStilte. Papa denkt aan zijn werkdag.\nBij school: 'Zo. Dag schat. Doe je best.'\nRoos stapt af. 'Dag papa.'\n\nTien minuten samen. Nul verbinding. Het ritje is vervoer, geen ritueel. Roos herinnert zich hier niks van.",
      rightApproach: "✅ HET GEKKE-STEMMEN RITJE:\n\nPapa fietst. Roos zit achterop.\n'Roos. Welke stem wil je vandaag?'\nRoos: 'De piraat!'\nPapa praat de rest van de rit als een piraat. Over alles. De bomen, de hond die ze passeren, de juf.\nRoos giert het uit.\nBij school: 'Arrr, tot vanmiddag, maatje!'\nRoos op het schoolplein tegen een vriendin: 'Mijn papa is een piraat.'\n\nZelfde rit. Zelfde tien minuten. Maar nu is het van hen.",
      explanation: "De fietsrit gebeurt toch al. Het kost geen extra tijd. Maar door er een terugkerend spel van te maken, verandert vervoer in een ritueel. De gekke stemmen worden hun ding. Over tien jaar zegt Roos: 'Mijn vader deed altijd stemmetjes op de fiets.' Niet omdat het bijzonder was. Maar omdat het elke dag was.",
    },
    {
      type: "text" as const,
      heading: "Je toolkit",
