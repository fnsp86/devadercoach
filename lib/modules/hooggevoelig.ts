...
export const HOOGGEVOELIG_MODULES: LearningModule[] = [
  {
    ...
    content: [
      ...
      },
      {
        type: "example" as const,
        situation:
          "Finn (8) zit in de auto op weg naar zwemles. Halverwege begint hij te huilen. 'Ik wil niet. Ik wil naar huis.' Vorige week ging het goed bij zwemles. Er is niks veranderd. Jij snapt het niet en je hebt een halfuur gereden.",
        wrongApproach:
          "❌ DOORZETTEN EN RELATIVEREN:\n\nPapa: 'Finn, we zijn er bijna. Vorige week vond je het nog leuk.'\nFinn huilt harder: 'Ik wil NIET!'\nPapa: 'We gaan. Je hebt je zwembroek al aan. Het is maar een uurtje.'\nBij het zwembad sleurt papa Finn naar binnen. Finn doet mee, maar zegt niks meer. Na afloop is hij uren stil.\nDie nacht wordt hij wakker van een nachtmerrie.\n\nWat er was: Finn had op school gehoord dat er vandaag een nieuwe zwemleraar is. Dat ene stukje onzekerheid was genoeg om zijn hele systeem te laten vollopen. Papa zag het niet, want er was 'niks veranderd'.",
        rightApproach:
          "✅ STOPPEN EN AFSTEMMEN:\n\nPapa hoort het huilen. Zet de auto aan de kant.\n'Hé. Ik stop even. Vertel, wat is er?'\nFinn, snikkend: 'Er is een nieuwe juf bij zwemmen.'\nPapa: 'Ah. Iemand die je niet kent. Dat is spannend.'\nFinn knikt.\nPapa: 'Weet je wat, we rijden erheen. We gaan eerst even samen kijken. Als je dan wilt, doe je mee. Als het niet lukt, gaan we weer.'\nBij het zwembad kijkt Finn door het raam. Ziet de nieuwe juf. 'Ze lacht.'\n'Ja. Ziet er oké uit, toch?'\nFinn gaat naar binnen. Doet mee. Na afloop: 'Ze was best aardig.'\n\nWat papa deed: hij stopte, luisterde, en gaf Finn een veilige optie. Niet dwingen, niet opgeven. Een tussenweg.",
        explanation:
          "Bij hooggevoelige kinderen kan een kleine, onzichtbare verandering het hele systeem ontregelen. Een nieuwe leraar, een ander rooster, een andere geur in de kleedkamer. Wat voor andere kinderen een detail is, is voor hen een onbekende wereld. Pluess' onderzoek naar vantage sensitivity laat zien dat deze kinderen extreem gevoelig zijn voor hun omgeving, in het positieve en het negatieve. Door even te stoppen en af te stemmen in plaats van door te duwen, leer je het kind: je gevoel is informatie, geen obstakel. En door een tussenstap aan te bieden (eerst kijken, dan beslissen) geef je het zenuwstelsel de kans om bij te stellen.",
      },
