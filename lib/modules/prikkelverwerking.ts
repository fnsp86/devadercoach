...
export const PRIKKELVERWERKING_MODULES: LearningModule[] = [
  {
    ...
    content: [
      ...
      },
      {
        type: "example" as const,
        situation:
          "Sem (8) zit aan het avondeten. Na twee happen duwt hij zijn bord weg. 'Ik lust dit niet. Het voelt raar.' Het zijn aardappelen met sperziebonen en gehakt, een maaltijd die hij eerder gewoon at. Zijn broertje eet door. Jij hebt een halfuur gekookt. Je partner kijkt je aan.",
        wrongApproach:
          "❌ DOORDRUKKEN EN MINIMALISEREN:\n\nPapa: 'Sem, er is niks raars aan. Eet gewoon door.'\nSem: 'De bonen zijn slijmerig.'\nPapa: 'Dat zijn gewoon bonen. Je broertje eet ze ook. Drie happen nog, dan mag je van tafel.'\nSem neemt een hap. Kokhalst. Papa, geïrriteerd: 'Doe niet zo dramatisch.'\nSem begint te huilen. Het eten eindigt in stilte. Sem gaat met honger naar bed.\n\nWat Sem leerde: mijn mond liegt kennelijk. Wat ik voel bestaat niet. Papa wordt boos als ik eerlijk ben over eten.",
        rightApproach:
          "✅ SERIEUS NEMEN EN CREATIEF OPLOSSEN:\n\nPapa kijkt naar het bord. 'Voelt raar. Wat precies?'\nSem: 'De bonen. Ze zijn zo... glad.'\nPapa knikt. 'Oké. De textuur is moeilijk voor je. Weet je wat, ik bak er een paar even kort in de pan. Worden ze krokanter. Wil je dat proberen?'\nSem knikt.\nTwee minuten later staan de bonen knapperig op zijn bord. Sem eet ze op.\nPapa: 'De aardappelen? Die zijn oké?'\nSem: 'Ja, die zijn goed.'\nHet eten gaat verder. Geen strijd, geen honger, geen tranen.\n\nWat papa deed: hij nam de sensorische informatie serieus en paste de textuur aan zonder het doel (eten) los te laten.",
        explanation:
          "Veel kinderen met prikkelverwerking-uitdagingen ervaren eten als een sensorisch mijnenveld. De textuur, temperatuur, geur en het mondgevoel van voedsel worden intenser verwerkt. Lucy Jane Miller beschrijft dat orale tactiele gevoeligheid een van de meest voorkomende prikkelverwerking-uitdagingen is. Een sperzieboon die voor jou gewoon glad is, voelt voor Sem als iets slijmerigs dat niet in zijn mond hoort. Door de textuur aan te passen (krokant bakken) in plaats van het kind te dwingen, houd je de grens (je eet mee aan tafel) intact terwijl je het zenuwstelsel respecteert. Dezelfde aanpak als bij de schoenen: zelfde doel, aangepaste route.",
      },
      // ── 5. Verdieping ──────────────────────────────────────────
      {
        type: "text" as const,
