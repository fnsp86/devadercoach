...
export const LASTIG_GEDRAG_MODULES: LearningModule[] = [
  {
    ...
    content: [
      ...
      },
      {
        type: "example" as const,
        situation:
          "Roos (6) moet haar jas en schoenen aandoen om naar school te gaan. Het is 08:10, je moet over vijf minuten de deur uit. Roos zit op de grond en weigert te bewegen. 'Ik wil niet naar school!' Gisteren was hetzelfde. En eergisteren ook. Elke ochtend wordt het erger.",
        wrongApproach:
          "❌ DREIGEN EN SLEPEN:\n\nPapa: 'Roos, we gaan. Nu. Ik tel tot drie.'\nRoos drukt zich plat op de grond.\nPapa: 'Een... twee...'\nRoos begint te gillen.\nPapa tilt haar op, trekt haar jas aan terwijl ze schopt.\nIn de auto huilt ze. Bij school klampt ze zich vast aan je been.\nJij trekt je los en loopt weg. Met een knoop in je maag.\n\nRoos leerde: ochtenden zijn eng. Papa wordt boos. En ik word meegesleurd naar een plek waar iets is wat ik niet aankan.",
        rightApproach:
          "✅ HET PROBLEEM ACHTER DE WEIGERING ZOEKEN:\n\nPapa hurkt. 'Hé Roos. Je wilt niet naar school. Dat hoor ik. Wat is er moeilijk?'\nRoos, zacht: 'Tygo pakt altijd mijn stoel af.'\nPapa: 'Ah. Dat klinkt vervelend. Elke dag?'\nRoos knikt.\nPapa: 'Oké. We gaan vandaag naar school. En ik schrijf een briefje aan juf Marieke over Tygo en de stoel. Goed?'\nRoos denkt na. 'Beloof je het?'\n'Ik beloof het.'\nRoos staat op. Trekt haar jas aan. Niet blij, maar ze gaat.\n\nWat papa deed: hij keek voorbij het gedrag (weigeren) naar het probleem eronder (een conflict op school dat Roos niet kon oplossen).",
        explanation:
          "Ross Greene zegt: achter elk 'lastig' gedrag zit een onopgelost probleem of een ontbrekende vaardigheid. Roos weigerde niet omdat ze dwars was. Ze weigerde omdat er iets op school gebeurde dat ze niet aankon en niet kon verwoorden. Door te vragen in plaats van te duwen, ontdekte papa het echte probleem. De grens bleef staan (je gaat naar school), maar het kind kreeg hulp bij wat het echt nodig had: een volwassene die het probleem serieus nam.",
      },
      ...
      // ── 7. Toolkit ──────────────────────────────────────────────
      {
        ...
        text: "1. De STOP-techniek (voor jou). Voordat je reageert op lastig gedrag: Stop. Adem. Observeer. Kies dan pas je reactie. Die vijf seconden pauze zijn het verschil tussen reageren vanuit frustratie en reageren vanuit begrip. Je kind triggert je. Dat is normaal. Maar jouw reactie bepaalt of de spiraal omhoog of omlaag gaat.\n\n2. Bewegingspauzes. Kinderen met ADHD-kenmerken of prikkelverwerkingsuitdagingen hebben meer beweging nodig dan gemiddeld. Niet als straf. Als medicijn. Plan bewegingsmomenten in: voor huiswerk tien minuten rennen. Tussen twee taken door springoefeningen. Barkley noemt beweging de meest onderschatte interventie bij ADHD. Het kalmeert het zenuwstelsel en verbetert de focus.\n\n3. Visuele schema's. Hang een dagschema op waar je kind het kan zien. Gebruik pictogrammen voor jongere kinderen, korte tekst voor oudere. Maak er samen een. Het schema wordt hun externe directeur, het helpt hun brein met plannen en vooruitkijken. Tip: een klaar-vakje om af te vinken geeft een dopamine-boost. En dopamine is precies wat bij ADHD-kenmerken lager is.\n\n4. De rustige plek. Geen strafhoek. Een plek in huis waar je kind naartoe kan als het te veel wordt. Met een kussen, een knuffeldier, misschien een stressbal. Het kind kiest er zelf voor. Jij zegt: ik zie dat het veel is, wil je even naar je rustige plek? Dit leert zelfregulatie: ik merk dat het te veel is en ik doe er iets mee. Dat is een vaardigheid voor het leven.\n\n5. De sportverslaggever-techniek. Beschrijf wat je ziet, zonder oordeel. Ik zie dat je boos bent. Je gooit met je speelgoed. Je ademhaling is snel. Alsof je een sportverslaggever bent die verslag doet. Dit doet drie dingen: het laat je kind weten dat je het ziet, het activeert hun denkbrein en het helpt ze verbinding maken tussen hun gevoel en hun gedrag. Greene beschrijft dit als de basis van collaboratief probleemoplossen.",
      },
      // ── 8. Oefening ─────────────────────────────────────────────
      {
